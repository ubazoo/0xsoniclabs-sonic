...
func (m *Mockevaluator) evaluate(context context.Context, blockInfo *BlockInfo, candidates []*types.Transaction, gasLimit uint64) ([]*types.Transaction, uint64, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "evaluate", context, blockInfo, candidates, gasLimit)
...
func (mr *MockevaluatorMockRecorder) evaluate(context, blockInfo, candidates, gasLimit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "evaluate", reflect.TypeOf((*Mockevaluator)(nil).evaluate), context, blockInfo, candidates, gasLimit)
}
...
func (m *Mockprocessor) Run(tx *types.Transaction, remainingGas uint64) (runResult, uint64) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Run", tx, remainingGas)
...
func (mr *MockprocessorMockRecorder) Run(tx, remainingGas any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Run", reflect.TypeOf((*Mockprocessor)(nil).Run), tx, remainingGas)
}
