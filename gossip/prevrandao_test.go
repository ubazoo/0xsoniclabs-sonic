...
func TestComputePrevRandao_ComputationProducesCorrectValue(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name: "one_event",
			events: consensus.EventHashes{
				consensus.HexToEventHash("0x1234"),
			},
		...
		},
		{
			...
			events: consensus.EventHashes{
				consensus.HexToEventHash("0x5678"),
				consensus.HexToEventHash("0x9012"),
				consensus.HexToEventHash("0x3456"),
			},
