...
func ExportEvents(gdbParams db.GossipDbParameters, w io.Writer, from, to consensus.Epoch) (err error) {
	...
	gdb.ForEachEventRLP(from.Bytes(), func(id consensus.EventHash, event rlp.RawValue) bool {
