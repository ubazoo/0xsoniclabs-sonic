...
func FakeGenesisStore(num idx.Validator, balance, stake *big.Int, hardFork opera.HardFork) *genesisstore.Store {
	return FakeGenesisStoreWithRules(num, balance, stake, opera.FakeNetRules(hardFork))
}
